    ...
    node("nonSGX") {
        timeout(GLOBAL_TIMEOUT_MINUTES) {
            ...
            stage("Build Ubuntu Deploy Docker image") {
                oeDeploy = oe.dockerImage("oetools-deploy:terraform", ".jenkins/Dockerfile.deploy", buildArgs)
            }
...
buildDockerImages()
parallel "Build Ubuntu 16.04" : { buildVMImage("ubuntu", "16.04", "oetools-deploy:terraform") },
         "Build Ubuntu 18.04" : { buildVMImage("ubuntu", "18.04", "oetools-deploy:terraform") },
         "Build Windows 2016" : { buildVMImage("win", "2016", "oetools-deploy:terraform") },
         "Build Windows 2016 DCAP" : { buildVMImage("win", "dcap", "oetools-deploy:terraform") }
